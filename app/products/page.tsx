...
export default async function ProductsPage() {
  ...
  return <>
    <header className="site-header"><a className="brand" href="/"><span aria-hidden>♛</span> CrownConnect</a><nav aria-label="Primary navigation"><a href="/marketplace">Find a stylist</a><a href="/products">Hair products</a></nav>{user ? <AccountMenu role={account?.primary_role} name={user.fullName ?? user.email} /> : <LandingNavLink className="button secondary" href="/register">Create account</LandingNavLink>}</header>
