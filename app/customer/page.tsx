...
export default async function CustomerSpace() {
  ...
  return <main className="page-shell customer-space">
    ...
    <section className="customer-actions"><Link className="button" href="/#stylists">Find a stylist</Link><Link className="button ghost" href="/my-bookings">View my bookings</Link></section>
